# NOTE: As of 2025-06-24, the gemma3n models are still not available on Ollama.
...
def save_results_to_csv(results, filename=None):
    ...
    if filename is None:
        ...
        filename = f"sms_experiment_ollama_results_{timestamp}.csv"
    ...
    for prompt_name, prompt_data in prompts.items():
        ...
        for sms_item in small_test_dataset:
            ...
            for attempt in range(retries):
                try:
                    # Make the LLM call using Ollama
                    ...
                    # Handle potential errors with Ollama
